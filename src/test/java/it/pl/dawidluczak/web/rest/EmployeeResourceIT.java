...
class EmployeeResourceIT {
    ...
    void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getHours()).isEqualTo(DEFAULT_HOURS);
    ...
    void putNewEmployee() throws Exception {
        ...
        assertThat(testEmployee.getHours()).isEqualTo(UPDATED_HOURS);
    ...
    void partialUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.lastName(UPDATED_LAST_NAME).email(UPDATED_EMAIL).note(UPDATED_NOTE);
