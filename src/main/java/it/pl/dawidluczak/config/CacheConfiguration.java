...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, it.pl.dawidluczak.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, it.pl.dawidluczak.repository.UserRepository.USERS_BY_EMAIL_CACHE);
