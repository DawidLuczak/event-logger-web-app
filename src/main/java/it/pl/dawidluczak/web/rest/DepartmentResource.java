...
import it.pl.dawidluczak.web.specification.DepartmentSpecification;
...
/**
 * REST controller for managing {@link it.pl.dawidluczak.domain.Department}.
 */
@RestController
@RequestMapping("/api")
public class DepartmentResource {
    ...
    public Page<DepartmentDTO> search(@RequestBody SearchQuery searchQuery, Pageable page) {
        log.debug("REST request to search Departments");
        return departmentService.search(searchQuery, page);
    }

    @GetMapping("/departments/countAll")
    public ResponseEntity<Long> countAllDepartments() {
        log.debug("REST request to get number of all Departments");
        Optional<Long> numberOfRecords = Optional.of(departmentRepository.count());
        return ResponseUtil.wrapOrNotFound(numberOfRecords);
    }
